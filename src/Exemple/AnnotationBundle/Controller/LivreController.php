...
use Exemple\AnnotationBundle\Entity\Livre;
use Exemple\AnnotationBundle\Form\LivreType;
...
class LivreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ExempleAnnotationBundle:Livre')->findAll();
     ...
     * @Method("POST")
     * @Template("ExempleAnnotationBundle:Livre:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ExempleAnnotationBundle:Livre')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ExempleAnnotationBundle:Livre:edit.html.twig")
     */
